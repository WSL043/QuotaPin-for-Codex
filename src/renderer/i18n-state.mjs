export function createI18nToolkit() {
  ...
  const translations = {
    "zh-CN": {
      ...
      "Identity": "账户", "Forecast": "趋势", "Signals": "提醒", "Usage": "用量", "Time": "时间", "Value color": "数字颜色", "Dot color": "圆点颜色", "Name color": "用户名颜色",
      "Badge size": "额度字号", "Quota": "额度", "Account row": "账户栏", "Account row mode": "账户栏模式", "Legacy": "Legacy", "Beta": "Beta", "Applies to every saved view.": "对所有已保存搭配生效。", "Beta hides Help and gives short/hold gestures the whole footer.": "Beta 会隐藏问号，并让整段底栏都能识别短按与长按。", "Order": "顺序", "Visible modules": "可见模块", "Click to show or hide. Close the panel, then drag modules at their display position.": "点击显示或隐藏；关闭面板后，可在实际显示位置直接拖动排序。", "Drag modules to arrange the account row": "拖动模块调整账户栏顺序", "Drag modules to arrange this surface": "拖动模块调整当前位置的顺序", "Drag modules with alignment guides": "拖到边缘、中线或附近模块即可对齐", "Drag modules to place them freely": "拖动模块自由定位", "Drop anywhere · Collisions make room": "落在任意位置 · 重叠时自动让位", "Precise placement · Collisions make room": "精确落点 · 重叠时自动让位", "Drop anywhere · Aligns near edges or modules": "自由落点 · 靠近边缘或模块时自动对齐", "Magnetic alignment · Left, center, right, or nearby modules": "磁性对齐 · 左、中、右或附近模块",
      "Placement": "显示位置", "Account footer": "账户栏", "Title center": "标题栏中央", "Workspace top": "工作区顶部", "Composer center": "输入框上方", "Composer toolbar": "输入框工具栏", "Quota rail": "额度线位置", "Account rail": "账户栏底部", "Composer rail": "输入框底部", "Below composer": "输入框外侧底部", "Unavailable in this window": "当前窗口空间不足", "Using account footer": "已回到账户栏", "Show burn pace": "显示消耗速度", "Show estimated runway": "显示预计可用时间",
      ...
      "Short click: Codex menu · Hold: QuotaPin": "短按：Codex 菜单 · 长按：QuotaPin", "Language": "语言", "Codex remaining quota": "Codex 剩余额度", "Quota data is temporarily unavailable": "额度暂时未同步",
    ...
    ja: {
      ...
      "Percentage": "パーセント", "Countdown": "残り時間", "Seconds": "秒カウント", "Date": "日付", "Reset": "リセット時刻", "Show value": "数値を表示", "Show status dot": "状態ドット", "Show quota bar": "残量バー", "Show module quota bar": "残量表示に合わせるバー", "Show full-width quota bar": "アカウント欄いっぱいのバー", "Show window label": "期間ラベル", "Show countdown": "残り時間を表示", "Show compact countdown": "コンパクト表示（d / h）", "Show local countdown": "日本語の残り時間を表示", "4 days 8 hours": "4日8時間", "Show seconds": "秒カウントを表示", "Show reset date": "リセット日を表示", "Show reset time": "リセット時刻を表示", "Show today's tokens": "今日のトークン", "Show lifetime tokens": "累計トークン",
      ...
      "Identity": "アカウント", "Forecast": "予測", "Signals": "通知", "Usage": "使用量", "Time": "時刻", "Value color": "数値の色", "Dot color": "ドットの色", "Name color": "ユーザー名の色",
      "Badge size": "残量の文字サイズ", "Quota": "残量", "Account row": "アカウント欄", "Account row mode": "アカウント欄モード", "Legacy": "Legacy", "Beta": "Beta", "Applies to every saved view.": "保存したすべてのビューに適用されます。", "Beta hides Help and gives short/hold gestures the whole footer.": "Beta はヘルプを隠し、フッター全体で短押しと長押しを判定します。", "Order": "並び順", "Visible modules": "表示する項目", "Click to show or hide. Close the panel, then drag modules at their display position.": "クリックで表示を切り替えます。パネルを閉じると、実際の表示位置で項目をドラッグして並べ替えられます。", "Drag modules to arrange the account row": "ドラッグして並び順を変更", "Drag modules to arrange this surface": "この位置でドラッグして並び順を変更", "Drag modules with alignment guides": "端・中央・近くの項目に合わせて配置", "Drag modules to place them freely": "ドラッグして自由に配置", "Drop anywhere · Collisions make room": "好きな位置に配置 · 重なると自動で間隔を確保", "Precise placement · Collisions make room": "正確に配置 · 重なると自動で間隔を確保", "Drop anywhere · Aligns near edges or modules": "自由に配置 · 端や項目の近くで自動整列", "Magnetic alignment · Left, center, right, or nearby modules": "磁気整列 · 左・中央・右・近くの項目",
      "Placement": "表示位置", "Account footer": "アカウント欄", "Title center": "タイトルバー中央", "Workspace top": "ワークスペース上部", "Composer center": "入力欄の上", "Composer toolbar": "入力欄ツールバー", "Quota rail": "残量バーの位置", "Account rail": "アカウント欄の下", "Composer rail": "入力欄の下", "Below composer": "入力欄の外側下部", "Unavailable in this window": "このウィンドウでは空きがありません", "Using account footer": "アカウント欄に戻しています", "Show burn pace": "消費ペースを表示", "Show estimated runway": "使用可能見込みを表示",
      ...
      "Short click: Codex menu · Hold: QuotaPin": "短押し：Codex メニュー · 長押し：QuotaPin", "Language": "言語", "Codex remaining quota": "Codex の残り使用量", "Quota data is temporarily unavailable": "残量を一時的に取得できません",

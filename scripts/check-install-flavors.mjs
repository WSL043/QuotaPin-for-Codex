...
lacks(macBuilder, 'build_sea "$ROOT/src/injector.mjs" "QuotaPin.Agent"', "the macOS build must not embed a second Node runtime for the Agent");
...
lacks(macPackager, 'for binary in QuotaPin.Agent QuotaPin.Mac', "the macOS package must contain one universal runtime host");

export function createI18nToolkit() {
  ...
  const translations = {
    "zh-CN": {
      ...
      "Placement": "显示位置", "Account footer": "账户栏", "Title center": "标题栏中央", "Bottom left": "输入区左侧", "Composer center": "输入框中央", "Bottom right": "输入区右侧", "Quota rail": "额度线位置", "Account rail": "账户栏底部", "Composer rail": "输入框底部", "Unavailable in this window": "当前窗口空间不足", "Using account footer": "已回到账户栏",
    ...
    ja: {
      ...
      "Placement": "表示位置", "Account footer": "アカウント欄", "Title center": "タイトルバー中央", "Bottom left": "入力欄の左", "Composer center": "入力欄の中央", "Bottom right": "入力欄の右", "Quota rail": "残量バーの位置", "Account rail": "アカウント欄の下", "Composer rail": "入力欄の下", "Unavailable in this window": "このウィンドウでは空きがありません", "Using account footer": "アカウント欄に戻しています",

export function createI18nToolkit() {
  ...
  const translations = {
    "zh-CN": {
      ...
      "Quick": "快速", "Customize": "自定义", "Badge": "额度标记", "Place": "位置", "Account": "账号", "Composition": "组合", "Color": "颜色", "Motion": "动态",
    ...
    ja: {
      ...
      "Quick": "かんたん", "Customize": "カスタマイズ", "Badge": "残量表示", "Place": "位置", "Account": "アカウント", "Composition": "構成", "Color": "カラー", "Motion": "動き",
      ...
      "Attention": "通知効果", "Animate": "対象", "Start at": "開始レベル",

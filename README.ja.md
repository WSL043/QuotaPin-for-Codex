...
- 残りパーセント
- 公式の残りパーセント推移から求める、直近のアカウント全体の消費ペースと使用可能見込み
...
2.x の複数位置ベータでは、長押し領域も実際の表示位置へ移動します。タイトル中央、ワークスペース上部、入力欄の上、アカウント欄で、同じ長押し・ドラッグ・衝突回避・整列ロジックを使います。操作範囲が不安定だった入力欄の左右スロットは削除しました。

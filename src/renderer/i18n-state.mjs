export function createI18nToolkit() {
  ...
  const translations = {
    "zh-CN": {
      ...
      "Placement": "显示位置", "Account footer": "账户栏", "Title center": "标题栏中央", "Workspace top": "工作区顶部", "Composer center": "输入框上方", "Quota rail": "额度线位置", "Account rail": "账户栏底部", "Composer rail": "输入框底部", "Below composer": "输入框外侧底部", "Unavailable in this window": "当前窗口空间不足", "Using account footer": "已回到账户栏", "Show burn pace": "显示消耗速度", "Show estimated runway": "显示预计可用时间",
